...
import org.group_three.constants.enums.Sort;
...
public class Statistic<T extends Record> extends Table<T> {
    ...
    Statistic<T> sortBy(
        ...
        return sortBy(attribute, Sort.DESC);
    }
     ...
     * @param sorttype The direction of the sorting. Sort.DISC or Sort.ASC
     * @return A new Statistic, sorted by <code>attribute</code>.
     * @author Luca
     * @see Sort#ASC
     * @see Sort#DESC
    ...
    Statistic<T> sortBy(
        ...
        if(sorttype == Sort.ASC) outstat.content = sortcon;
