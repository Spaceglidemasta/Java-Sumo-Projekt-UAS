...
public class Statistic<T extends Record> extends Table<T> implements Iterable<T> {
     ...
     * @return an exact replica of this instance
     * @author Luca
     * */
    public Statistic<T> fork(){
        Statistic<T> outstat = new Statistic<>(name, attributeNames);
        outstat.content = content;
        outstat.description = description;
        return outstat;
    }
    ...
    /**
     * SortDir by the given attribute.
     * @param keyExtractor The method to get the wanted attribute. Autogenerated by Java when creating Records.
     ...
     * */
    public <U> Statistic<T> aggregate(
